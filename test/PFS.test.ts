...
describe('PageFileSystem', () => {
  ...
  beforeEach(() => {
    ...
    pfs = new PageFileSystem(fd, PAGE_SIZE, PAGE_CACHE_CAPACITY, { pageSize: PAGE_SIZE, pageCacheCapacity: PAGE_CACHE_CAPACITY, pagePreallocationCount: 1, wal: null, walCheckpointThreshold: 1000 })
